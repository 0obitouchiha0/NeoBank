...
function NewsSlider() {
    ...
    const btnLeft = React.useRef<HTMLButtonElement>(null);
    const btnRight = React.useRef<HTMLButtonElement>(null);
    ...
    return (
        <>
            ...
            <div className={styles['news-btns']}>
                <button className={clsx(styles['news-btns__item'], styles['news-btns__item--left'])} disabled={btnLeftDisabled} ref={btnLeft} onClick={swipeRight}>
                ...
                <button className={clsx(styles['news-btns__item'], styles['news-btns__item--right'])} disabled={btnRightDisabled} ref={btnRight} onClick={swipeLeft}>
                    <svg width="25" height="26" viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
